...
"text-align: center;"))
        ...
        self.SQLStartUrlLineEdit = QtGui.QLineEdit(self.SQLInputWidget)
        self.SQLStartUrlLineEdit.setGeometry(QtCore.QRect(95, 115, 321, 25))
        self.SQLStartUrlLineEdit.setStyleSheet(_fromUtf8("font-size:13px;border-radius: 10px;"))
        self.SQLStartUrlLineEdit.setObjectName(_fromUtf8("SQLStartUrlLineEdit"))
        self.SQLStartUrlLabel = QtGui.QLabel(self.SQLInputWidget)
        self.SQLStartUrlLabel.setGeometry(QtCore.QRect(20, 120, 81, 20))
        self.SQLStartUrlLabel.setStyleSheet(_fromUtf8("color: rgb(255, 255, 255);\n"
"font-size: 15px;\n"
"text-align: center;"))
        self.SQLStartUrlLabel.setObjectName(_fromUtf8("SQLStartUrlLabel"))
        ...
        self.FileStartUrlLabel = QtGui.QLabel(self.FileInputWidget)
        self.FileStartUrlLabel.setGeometry(QtCore.QRect(20, 148, 81, 20))
        self.FileStartUrlLabel.setStyleSheet(_fromUtf8("color: rgb(255, 255, 255);\n"
"font-size: 15px;\n"
"text-align: center;"))
        self.FileStartUrlLabel.setObjectName(_fromUtf8("FileStartUrlLabel"))
...
"text-align: center;"))
        ...
        self.FileStartUrlLineEdit = QtGui.QLineEdit(self.FileInputWidget)
        self.FileStartUrlLineEdit.setGeometry(QtCore.QRect(165, 143, 251, 25))
        self.FileStartUrlLineEdit.setStyleSheet(_fromUtf8("font-size:13px;border-radius: 10px;"))
        self.FileStartUrlLineEdit.setObjectName(_fromUtf8("FileStartUrlLineEdit"))
...
"QPushButton:hover{background-image:url(:/images/images/AddFiletypesButtonHover.png);}"))
        ...
        self.label = QtGui.QLabel(self.FileInputWidget)
        self.label.setGeometry(QtCore.QRect(170, 210, 111, 16))
...
"text-align: center;"))
        ...
        BaseWidget.setTabOrder(self.OpenFileButton, self.FileStartUrlLineEdit)
        BaseWidget.setTabOrder(self.FileStartUrlLineEdit, self.FilterKeyWordLineEdit)
        ...
        BaseWidget.setTabOrder(self.OutputTableWidget, self.SQLStartUrlLineEdit)
        BaseWidget.setTabOrder(self.SQLStartUrlLineEdit, self.MinButton)
    ...
    def retranslateUi(self, BaseWidget):
        ...
        self.label.setText(_translate("BaseWidget", "split by semicolon", None))
